...
/**
 * Google Gemini implementation using gemini-embedding-2.
 * Requests 1536 dimensions natively via outputDimensionality — the API
 * auto-truncates and re-normalizes, so no manual post-processing needed.
 */
export class GeminiEmbeddingService implements EmbeddingService {
  ...
  async generateEmbeddings(texts: string[]): Promise<number[][]> {
    ...
    // The API returns correctly normalized 1536-dim vectors directly
